...
class Ui_Play_FJ(object):
        ...
        "background: transparent;")
                ...
                self.btn_back.clicked.connect(Play_FJ.hide)
        ...
        def retranslateUi(self, Play_FJ):
                ...
                self.label_score.setText(_translate("Play_FJ", "0"))
                        ...
                        if filesize == 0:
                                ...
                                with open(file,encoding="UTF-8") as f:
                                        for line in f:
                                                ...
                                                f_j.setdefault(Question,[])
                                                f_j[Question].append(Answer)
                                        random_ae = random.choice(list(f_j.items()))
                                ans = ", "
