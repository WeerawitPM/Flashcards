...
class Ui_Play_PT(object):
        ...
        "background: transparent;")
                ...
                self.btn_back.clicked.connect(Play_PT.hide)
        ...
        def retranslateUi(self, Play_PT):
                ...
                self.label_score.setText(_translate("Play_PT", "0"))
                        ...
                        if filesize == 0:
                                ...
                                with open(file,encoding="UTF-8") as f:
                                        for line in f:
                                                ...
                                                p_t.setdefault(Question,[])
                                                p_t[Question].append(Answer)
                                        random_ae = random.choice(list(p_t.items()))
                                ans = ", "
